...
/*
  IMPORTANTE:
  Next.js NO soporta `figma:asset`
  Para los productos 7, 8 y 9 usa una imagen pública
  (luego la puedes cambiar)
*/
...
export function Catalog() {
  ...
  return (
    <section
      id="catalogo"
      className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-[--color-cream] to-white"
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            ...
            personalizados. Cada pieza está hecha con amor y dedicación.
          </p>
        </div>
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full transition-colors ${
                selectedCategory === category
                  ? "bg-[--color-dusty-rose] text-white"
                  : "bg-[--color-cream] text-[--color-dark-sage] hover:bg-[--color-beige]"
              }`}
            >
              {category}
            </button>
